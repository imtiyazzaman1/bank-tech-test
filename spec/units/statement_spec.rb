...
describe Statement do
  ...
  describe '#print' do
    it 'displays the stored transactions' do
      ...
      allow(transaction_1).to receive(:balance).and_return('1000.00')
      allow(transaction_1).to receive(:amount).and_return('1000.00')
      ...
      allow(transaction_2).to receive(:balance).and_return('700.00')
      allow(transaction_2).to receive(:amount).and_return('300.00')
